 ...
 *
 * Disassembly of SSDT-7-ProjSsdt.aml, Mon Dec 31 10:03:42 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001C69 (7273)
 *     Revision         0x02
 *     Checksum         0xF0
 *     OEM ID           "LENOVO"
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "ProjSsdt", 0x00000010)
{
    ...
    External (MEMB, UnknownObj)    // Warning: Unknown object
    ...
    Scope (\)
    {
        ...
        Name (CPL0, Buffer (0x10)
        {
            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            /* 0008 */  0x69, 0x10, 0x00, 0x03, 0x03, 0x00, 0x00, 0x00 
        })
        ...
        {
            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            /* 0008 */  0x59, 0x11, 0x00, 0x01, 0x03, 0x00, 0x00, 0x00 
        })
        ...
        {
            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            /* 0008 */  0x59, 0x10, 0x80, 0x01, 0x03, 0x00, 0x00, 0x00 
        })
        ...
        Name (PLD3, Buffer (0x10)
        {
            ...
            /* 0008 */  0x69, 0x11, 0x00, 0x02, 0x03, 0x00, 0x00, 0x00 
        })
        ...
        {
            /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00,
            /* 0008 */  0x69, 0x12, 0x80, 0x02, 0x03, 0x00, 0x00, 0x00 
        })
    ...
    Scope (\_SB.PCI0.XHC.RHUB.HS12.WCAM)
    {
        Method (_STA, 0, NotSerialized)  // _STA: Status
        {
            If (\WIN8)
