 ...
 *
 * Disassembly of SSDT-4-PegSsdt.aml, Sat Nov 23 13:50:23 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00002A53 (10835)
 *     Revision         0x02
 *     Checksum         0xF3
 *     OEM ID           "LENOVO"
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "PegSsdt", 0x00001000)
{
     ...
     * disassembly, but only 18 were resolved (1 unresolved). Additional
    ...
    External (_SB_.PCI0.PEG0.PEGP.DGCX, IntObj)    // (from opcode)
    ...
    External (_SB_.PCI0.PEG0.PEGP.HDAS, IntObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.NVPF, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.NVPO, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.OTMS, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.TDGC, IntObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.TGPC, MethodObj)    // 0 Arguments (from opcode)
    ...
    External (PINI, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (PPBA, IntObj)    // Warning: Unknown object
    ...
    Scope (\_SB.PCI0.PEG0)
    {
        ...
        OperationRegion (PER2, PCI_Config, 0xB0, 0x04)
        ...
        PowerResource (PG00, 0x00, 0x0000)
        {
            ...
            Method (_ON, 0, Serialized)  // _ON_: Power On
            {
                If (LGreater (OSYS, 0x07D9))
                {
                    Store (0x07, P0CM)
                    Store (Zero, P0PM)
                    If (CondRefOf (\_SB.PCI0.PEG0.PEGP.TDGC))
                    {
                        If (LEqual (\_SB.PCI0.PEG0.PEGP.TDGC, One))
                        {
                            If (LOr (LEqual (\_SB.PCI0.PEG0.PEGP.DGCX, 0x03), LEqual (\_SB.PCI0.PEG0.PEGP.DGCX, 0x04)))
                            {
    ...
    Scope (\_SB.PCI0)
    {
        ...
        OperationRegion (PCS0, SystemMemory, Add (XBAS, ShiftLeft (SBN0, 0x14)), 0x0500)
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            GPPR (PION, One)
            If (LEqual (\_SB.PCI0.PEG0.PEGP.OTMS, One))
            {
                If (LEqual (PION, Zero))
                {
                    Store (Zero, P0AP)
