 ...
 *
 * Disassembly of SSDT-x0_2-Cpu0Cst.aml, Wed Aug 21 17:04:05 2019
 *
...
{
    External (_SB_.PCI0.LPCB.EC__.C2SU, UnknownObj)    // (from opcode)
    ...
    Scope (\_SB.PR00)
    {
        ...
        Method (_CST, 0, Serialized)  // _CST: C-States
        {
            ...
            If (LEqual (\_SB.PCI0.LPCB.EC.C2SU, One))
            {
                If (And (CFGD, 0x20))
                {
